...
#ifndef ZEDUI_GEOMETRY_SIZE_H_
#define ZEDUI_GEOMETRY_SIZE_H_
...
template <class T>
inline std::ostream& operator<<(std::ostream& out, const zedui::TSize<T>& s) {
