...
#ifndef ZEDUI_GEOMETRY_MATRIX_H_
#define ZEDUI_GEOMETRY_MATRIX_H_
...
#include "zedui/geometry/matrix_decomposition.h"
...
namespace std {
inline std::ostream& operator<<(std::ostream& out, const zedui::Matrix& m) {
...
#endif  // ZEDUI_GEOMETRY_MATRIX_H_
