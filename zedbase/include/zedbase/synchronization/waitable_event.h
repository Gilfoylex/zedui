...
#ifndef ZEDBASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
#define ZEDBASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
...
class AutoResetWaitableEvent final {
 ...
 private:
  ...
  ZED_DISALLOW_COPY_AND_ASSIGN(AutoResetWaitableEvent);
};
...
class ManualResetWaitableEvent final {
 ...
 private:
  ...
  ZED_DISALLOW_COPY_AND_ASSIGN(ManualResetWaitableEvent);
};

}  // namespace zedbase

#endif  // ZEDBASE_SYNCHRONIZATION_WAITABLE_EVENT_H_
